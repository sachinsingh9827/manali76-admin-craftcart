...
const PAGE_SIZE = 5;
const BASE_URL = "https://craft-cart-backend.vercel.app"; // adjust if needed
...
const CouponList = () => {
    ...
    const fetchCoupons = async () => {
      ...
      try {
        const response = await axios.get(
          `${BASE_URL}/api/coupons?search=${encodeURIComponent(
            searchTerm
  ...
  // Optional local filtering if backend search isn't enough
    ...
    <div className="p-2 sm:p-4 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      {!loading && !error && filteredCoupons.length > 0 && (
        <ReusableTable
          ...
          onRowClick={(coupon) => navigate(`/admin/coupon/edit/${coupon._id}`)}
        />
      )}
