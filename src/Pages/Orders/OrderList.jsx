    ...
    <div className="p-2 sm:p-4 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <input
          ...
          className="p-2 sm:p-1 border rounded w-full sm:max-w-xs text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      {!loading && !error && filteredOrders.length > 0 && (
        <ReusableTable
          ...
          data={filteredOrders}
          onRowClick={(order) => navigate(`/admin/orders/edit/${order._id}`)}
        />
      )}
