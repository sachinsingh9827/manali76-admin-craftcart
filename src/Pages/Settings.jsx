  ...
  const renderRightContent = () => {
    switch (selectedMenu) {
      case "account":
        ...
        return (
          <p className="text-lg">Please select an option from the left.</p>
        );
      ...
      case "settings":
        return (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full space-y-4 text-[#004080] dark:text-yellow-400">
            <h3 className="text-xl font-semibold mb-4">Settings</h3>

            <div className="cursor-pointer px-4 py-2 rounded flex justify-between items-center hover:bg-gray-300 dark:hover:bg-gray-600 hover:text-[#004080] dark:hover:text-yellow-400 transition-colors">
              <span>Theme:</span>
              <ThemeToggleButton />
            </div>
            ...
            <div className="cursor-pointer px-4 py-2 rounded hover:bg-gray-300 dark:hover:bg-gray-600 hover:text-[#004080] dark:hover:text-yellow-400 transition-colors">
              Integration: Google ✅
            </div>
          </div>
        );
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white w-full">
      ...
      <div className="flex flex-col lg:flex-row w-full p-2 gap-2">
        {/* Left Sidebar for Account Options */}
